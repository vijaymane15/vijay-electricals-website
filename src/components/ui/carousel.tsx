...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute h-12 w-12 rounded-full shadow-md border-2 border-brand-red bg-white text-brand-red hover:bg-brand-red hover:text-white transition-colors duration-200",
        orientation === "horizontal"
